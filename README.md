...
- **Speech-to-text and AI response panels**: show the latest spoken/typed message and AI reply as large single-line text areas. Long text stays on one screen and can be scrolled horizontally.
