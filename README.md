...
- Shared prompt presets and the active prompt selection are stored in the container on a Docker volume and are available to all browser sessions through `http://localhost:<port>/api/prompt`.
