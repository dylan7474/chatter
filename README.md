...
- **Conversation scroller**: shows the latest spoken/typed message in large red text and the AI reply in large green text within one shared single-line horizontal scroller. Long text stays on one screen and can be scrolled sideways.
