...
- **Conversation scroller**: shows the latest spoken/typed message in large red text and the AI reply in large green text as one shared Amiga/Atari ST-inspired demo marquee. Text animates across the display with neon scanline effects instead of using a manual scrollbar.
